                ...
                <HStack className="justify-between items-center">
                  <HStack space="md" className="items-center">
                    ...
                    <VStack>
                      ...
                      <Text size="xs" className="text-slate-500">{user.email || 'No email'}</Text>
                    </VStack>
                  </HStack>
                  <HStack space="sm">
                    <Button 
            ...
            <VStack space="lg">
              <VStack space="xs">
                ...
                <Text size="sm" className="text-slate-500">
                  Apakah Anda yakin ingin menghapus user <Text className="font-bold text-slate-900">&quot;{userToDelete.username}&quot;</Text>? Tindakan ini tidak dapat dibatalkan.
                </Text>
              </VStack>
