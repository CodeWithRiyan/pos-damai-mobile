                ...
                <HStack className="justify-between items-center">
                  <VStack className="flex-1">
                    ...
                    <Text size="xs" className="text-slate-500 mt-1">
                      {role.permissions?.length || 0} permissions assigned • Level {role.level}
                    </Text>
                  </VStack>
                  <HStack space="sm">
                    <Button 
            ...
            <VStack space="lg">
              <VStack space="xs">
                ...
                <Text size="sm" className="text-slate-500">
                  Apakah Anda yakin ingin menghapus role <Text className="font-bold text-slate-900">&quot;{roleToDelete.name}&quot;</Text>? Tindakan ini tidak dapat dibatalkan.
                </Text>
              </VStack>
