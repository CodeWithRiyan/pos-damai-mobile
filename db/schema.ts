...
export const purchases = sqliteTable('purchases', {
  ...
  paymentTypeCommission: real('paymentTypeCommission').default(0),
  paymentTypeCommissionType: text('paymentTypeCommissionType').default('PERCENTAGE'),
  paymentTypeMinimalAmount: real('paymentTypeMinimalAmount').default(0),
  commission: real('commission').default(0),
...
export const purchaseItems = sqliteTable('purchase_items', {
  ...
  productBarcode: text('productBarcode'),
  ...
  variantCode: text('variantCode'),
  variantNetto: real('variantNetto'),
...
export const receivables = sqliteTable('receivables', {
  ...
  transactionLocalRefId: text('transactionLocalRefId'),
  transactionTotalAmount: real('transactionTotalAmount'),
  ...syncColumns,
});
...
export const transactionReturns = sqliteTable('transaction_returns', {
  ...
  employeeId: text('employeeId'),
  employeeName: text('employeeName'),
  originalTransactionLocalRefId: text('originalTransactionLocalRefId'),
  totalAmount: real('totalAmount').notNull(),
...
export const shifts = sqliteTable('shifts', {
  ...
  cashDrawerName: text('cashDrawerName'),
  userId: text('userId').notNull(),
  userName: text('userName'),
