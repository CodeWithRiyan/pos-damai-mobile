...
export default function PurchasingList() {
  ...
  const { cart, setOpenAddProduct } = usePurchasingStore();
          ...
          {!!cart.length && (
            <HStack space="md" className="w-full p-4">
              <Pressable
                ...
                onPress={() => router.navigate("/(main)/purchasing/checkout")}
              >
                <HStack space="md" className="items-center">
              ...
              <Pressable className="items-center justify-center size-16 rounded-lg border border-primary-500 bg-background-0 active:bg-primary-300">
