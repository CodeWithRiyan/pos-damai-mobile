...
export default function StoreSuppliesList({ isReport }: { isReport?: boolean }) {
  ...
  return (
    <Box className="flex-1 bg-white">
      <Header header={isReport ? 'LAPORAN KEBUTUHAN TOKO' : 'KEBUTUHAN TOKO'} isGoBack />
      <Box className="flex-1 bg-white">
            ...
            <VStack>
              ...
              {storeSupplies?.length === 0 && (
                <Box className="p-8 items-center">
                  <Text className="text-slate-400 italic">Belum ada data kebutuhan toko</Text>
                </Box>
              )}
            </VStack>
          </ScrollView>
