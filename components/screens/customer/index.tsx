...
import { Customer, useBulkDeleteCustomer, useCustomers } from "@/lib/api/customers";
...
export default function CustomerList() {
  ...
  const handleAdd = () => {
    ...
    router.push("/(main)/management/consumer-supplier/customer/add" as any);
  };
                ...
                <Pressable
                  ...
                  onPress={() => {
                    if (!!selectedItems?.length) {
                      ...
                      router.navigate(
                        `/(main)/management/consumer-supplier/customer/detail/${item.id}` as any
                      );
                      setSelectedItems(null);
                    }
                  }}
                  ...
                  <HStack className="justify-between items-center">
                    ...
                    <VStack className="items-end">
                      <Text className={`text-sm font-bold ${
                        item.category === 'WHOLESALE' ? 'text-green-600' : 'text-blue-600'
                      }`}>
                        {item.category === 'WHOLESALE' ? 'Grosir' : 'Retail'}
                      </Text>
                    </VStack>
                  </HStack>
                </Pressable>
