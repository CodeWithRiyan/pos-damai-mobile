...
const selectContentStyle = tva({
  base: 'px-0 border border-background-100',
});
...
type ISelectContent = React.ComponentProps<typeof UISelect.Content> & {
  className?: string;
};
const SelectContent = React.forwardRef<React.ComponentRef<typeof UISelect.Content>, ISelectContent>(
